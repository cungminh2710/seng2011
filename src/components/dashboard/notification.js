		...
		return (
			<Feed>
				<Feed.Event>
					...
					<Feed.Content>
						<Feed.Summary>
							<Feed.User>Anthony Mansour</Feed.User> added you as a friend
          <Feed.Date>1 Hour Ago</Feed.Date>
				...
				<Feed.Event>
					...
					<Feed.Content>
						<Feed.Summary>
							<a>Mirette Saleh</a> added <a>2 new illustrations</a>
				...
				<Feed.Event>
					...
					<Feed.Content>
						<Feed.Summary date='2 Days Ago' user='Courteney Home' content=' added you as a friend' />
						<Feed.Meta>
							<Feed.Like>
								<Icon name='like' />
								408 Likes
