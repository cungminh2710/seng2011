        ...
        return (
            <Container>
                <Segment color="orange" textAlign="center">
                    ...
                    <Link prefetch href={this.state.createHref}>
                        <Button color="orange" size="large">Create now!</Button>
                    </Link>
                    <Link prefetch href={this.state.joinHref}>
                        <Button size="large" color="blue" basic>
                            Join an event
                        </Button>
                    </Link>
                </Segment>
